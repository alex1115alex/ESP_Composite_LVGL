...
void ui_Home_Screen_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Mail_Counter, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Mail_Symbol, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_Home_Screen_Alt_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Mail_Counter1, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Mail_Symbol1, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_Home_Screen_Alt_2_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Mail_Counter2, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Mail_Symbol2, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_Home_Screen_Alt_3_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_Mail_Counter3, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Mail_Symbol3, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_Card_Search_Ver_screen_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_TapForMore, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
