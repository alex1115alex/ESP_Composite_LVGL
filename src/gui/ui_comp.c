...
lv_obj_t * ui_Card_Base_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_style_text_font(cui_Card_Content_Text, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(cui_Card_More_Text, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
